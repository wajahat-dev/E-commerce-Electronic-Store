 ...
 */
$wptools_help = '';
$wptools_help .= '<h4>' .esc_attr__("This plugin has currently more than 35 tools to help you to manage your WordPress site, included the dashboard with CPU/Disk/Memory usage charts and more info.", "wptools"); 
$wptools_help .= '<br>';
$wptools_help .= '<br>';
...
$wptools_help .= '<br>';
$wptools_help .= '8) '.   esc_attr__("Add Google Search Central (formerly Google Webmasters) HTML TAG.","wptools"); 
$wptools_help .= '<br>';
